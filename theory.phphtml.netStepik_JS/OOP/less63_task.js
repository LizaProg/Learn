...
class Student extends User {
    ...
    getCourse() {
        ...
        if (currMonth >= 9) {
            courseStudent = currYear - this.year + 1;
        } else {
            courseStudent = currYear - this.year;
        }
...
var studentKolya = new Student('Kolya', 'Vasechkin', 2013);
console.log(studentKolya.getFullName());
console.log(studentKolya.getCourse() + ' course');